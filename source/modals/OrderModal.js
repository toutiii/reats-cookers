                                        ...
                                        <View style={{flex: 1, flexDirection: 'row'}}>
                                            ...
                                            <View style={{flex: 3}}>
                                                <Text
                                                    ...
                                                    style={[
                                                        {fontSize: 18},
                                                        {textAlign:  key.toLowerCase().includes('total') ? 'center' : 'left'}
                                                    ]}>
                                                    {key}
                                                </Text>
                                            </View>
                                            <View style={{flex: 1, alignItems: 'flex-end'}}>
                                                {
                                                    key.toLowerCase().includes('total') ?
                                                        <Text style={{fontSize: 18}}>
                                                            {props.data[key][1]}{all_constants.currency_symbol}
                                                        </Text>
                                                        :
                                                        <Text style={{fontSize: 18}}>
                                                ...
                                                <Text style={{fontSize: 18, alignItems: 'center'}}>
                                                    {
                                                        key.toLowerCase().includes('total') ?
                                                            ...
                                                            :
                                                            <Text style={{fontSize: 18}}>
                                                                ={props.data[key][0] * props.data[key][1]}{all_constants.currency_symbol}
                                                            </Text>
                                                    }
                                                </Text>
                                            </View>
