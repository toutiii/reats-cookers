        ...
        <View style={{ flex: 1 }}>
            ...
            >
                    ...
                    <Image
                        source={{
                            uri:
                                ...
                                "M_bbWpTVNekL5O_MLzQ4dyInmJU=/750x/smart/" +
                                "1c9fe4d4419047f18efc37134a046e5a/recipe-jdf/1001383.jpg",
                        }}
                        style={{ flex: 1 }}
                    />
                </View>
                ...
                >
                    ...
                    <View style={stylesOrder.row_element}>
                        <View style={stylesOrder.icon_element}>
                            <MaterialCommunityIcons name='food-turkey' color='black' size={20} />
                        </View>
                        <View style={stylesOrder.order_status_text_style}>
                            <Text style={stylesOrder.order_text}>
