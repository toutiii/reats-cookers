    ...
    return(
        <View style={styles_balance.sub_container}>
            <View style={styles_balance.order_date}>
                <Text style={{fontSize: 18}}>{props.order_date}</Text>
            </View>
            <View style={styles_balance.order_number}>
                <Text style={{fontSize: 18}}>{all_constants.order.infos.number}{props.order_number}</Text>
            </View>
            <View style={styles_balance.order_balance}>
                <Text style={{fontSize: 18}}>{props.order_balance}{all_constants.currency_symbol}</Text>
            </View>
        </View>
    )
}