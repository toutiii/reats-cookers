...
export default class ToggleView extends Component {
  constructor(props) {
    ...
    this.offline_icon_uri =
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTH-AEN1kYTBtKWdVTnIblOQzv3GR1qa4oI5A&usqp=CAU";
    this.online_icon_uri =
      "https://pics.freeicons.io/uploads/icons/png/11875166141558096434-512.png";
  }
  render() {
    return (
