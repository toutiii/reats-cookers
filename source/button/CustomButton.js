                        ...
                        <View style={styles_settings.button_first_label}>
                            {
                                ...
                                :
                                    <Text numberOfLines={1} style={{ color:props.label_color, fontSize: props.font_size }}>{label}</Text>
                            }
                        </View>
                        <View style={styles_settings.button_second_label}>
                            <Text numberOfLines={1} style={{ color:props.label_color, fontSize: props.font_size }}>{props.second_label}</Text>
                        </View>
                    </View>
                :
                    <Text numberOfLines={1} style={{ color:props.label_color, fontSize: props.font_size }}>{label}</Text>
