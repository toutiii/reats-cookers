      ...
      <ThemedView>
        <Pressable style={{ flex: 1 }} onPress={() => Keyboard.dismiss()}>
          <VStack className="flex-1 px-6" space="xl">
            {/* Logo and App name */}
            <Center className="justify-center my-8">
              <Animated.Image entering={FadeIn.delay(300).duration(800)} style={{ width: 100, height: 100 }} source={require("@/assets/images/logos/logo.png")} resizeMode="contain" accessibilityLabel="Logo Reats Cookers" />
              <Animated.Text entering={FadeIn.delay(600).duration(800)} className="text-primary-500 text-3xl font-bold mt-2" style={{ letterSpacing: -0.3 }}>
                Reats Cookers
              </Animated.Text>
            </Center>
