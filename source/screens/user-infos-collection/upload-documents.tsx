      ...
      <SafeAreaView className="flex-1">
          ...
          <View className="flex-1 px-6 pt-4">
            <Box className="pt-4 pb-6">
              ...
              <Text className="text-base">
                Téléchargez une photo nette de votre certificat{"\n"}
            ...
            <VStack space="xl">
              ...
              <UploadSection title="Photo recto de votre certificat avec votre nom et les informations visibles" image={frontImage} onUpload={() => handleUploadPress("front")} testID="upload-front-photo" />

              {/* Upload Area - Back Side */}
              <UploadSection title="Photo verso de votre certificat (si applicable) avec toutes les informations" image={backImage} onUpload={() => handleUploadPress("back")} testID="upload-back-photo" />
            </VStack>
          </View>
        </ScrollView>
        ...
        >
          <Button
            ...
            accessibilityLabel="Soumettre les documents"
            accessibilityHint={canSubmit
? "Soumettre vos documents téléchargés"
: "Téléchargez les deux photos pour activer la soumission"}
