...
const PersonalDocumentsScreen = () => {
  ...
  const documents = [
    { id: "identity", title: "Carte d'identité ou Passeport" },
    { id: "hygiene", title: "Certificat d'hygiène alimentaire" },
    { id: "insurance", title: "Attestation d'assurance professionnelle" },
    { id: "siret", title: "Extrait KBIS ou SIRET" },
  ];
      ...
      <ThemedView className="flex-1 pt-4">
        <Box className="px-6 mb-6 mt-2">
          ...
          <Text className="text-gray-600 text-base mt-1">
            Téléchargez des photos nettes des documents{"\n"}
            ci-dessous pour une vérification rapide
          </Text>
        </Box>
